...
namespace SimpleLogger
{
    public static class Logger
    {
        ...
        public static void Log(string varName, object o)
        { 
        	Log(_defaultLevel,"Variable: " + varName + ": " + FormatValue(o));
        }
        
        public static void Log(string objName, object o, int depth)
        {
        	Log(_defaultLevel,"Variable: " + objName + ": " + ObjectDumper.Dump(o, depth));
        }
        ...
        public static void Log(Level level, string message)
        {
            ...
            Log(level, message, callingClass, callingMethod, lineNumber, threadID);
        }
        ...
        private static void Log(Level level, string message, string callingClass, string callingMethod, int lineNumber, int threadID)
        {
            ...
            var logMessage = new LogMessage(level, message, currentDateTime, callingClass, callingMethod, lineNumber, threadID);
