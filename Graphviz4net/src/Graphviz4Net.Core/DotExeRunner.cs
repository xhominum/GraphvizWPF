...
namespace Graphviz4Net
{
    ...
    public class DotExeRunner : IDotRunner
    {
        ...
        {
        	var toto = Environment.GetEnvironmentVariables();
        	//Environment.SetEnvironmentVariable("GraphvizPath", @"C:\Program Files (x86)\Graphviz2.38\bin", EnvironmentVariableTarget.Machine);
        	
        	this.DotExecutablePath = Environment.GetEnvironmentVariable("GraphvizPath", EnvironmentVariableTarget.Machine);
