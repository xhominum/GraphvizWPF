...
namespace Graphviz4Net.WPF.Example
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void zoomAndPanControl_MouseWheel(object sender, MouseWheelEventArgs e)
        {
            ...
            if (e.Delta > 0)
            {
                Point curContentMousePoint = e.GetPosition(GraphLayout);
        ...
        private void zoomAndPanControl_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            if ((Keyboard.Modifiers & ModifierKeys.Shift) == 0)
            {
                Point doubleClickPoint = e.GetPosition(GraphLayout);
        ...
        {
            GraphLayout.Focus();
            Keyboard.Focus(GraphLayout);

            mouseButtonDown = e.ChangedButton;
            origZoomAndPanControlMouseDownPoint = e.GetPosition(zoomAndPanControl);
            origContentMouseDownPoint = e.GetPosition(GraphLayout);
